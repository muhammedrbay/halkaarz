...
class RealtimePriceService {
  ...
  static Future<Map<String, double>> fetchAll({bool forceRefresh = false}) async {
    ...
    // Web ise Firebase kurulmamış olabilir
    if (kIsWeb) {
      debugPrint('[RTDB] Web platformunda Firebase Database atlanıyor.');
      return Map.unmodifiable(_cache);
    }
  ...
  static Future<double?> fetchSingle(String ticker) async {
    if (kIsWeb) return _cache[ticker];
